...
const Validation = (callback) => {
    ...
    const regForCategory = RegExp(/^[A-Z][a-zA-Z]{2,100}$/);
    ...
    const validate = (event, name, value) => {
        switch (name) {
            ...
            case "cpassword":
                ...
                break;
            case "category":
                errors.category = regForCategory.test(value)
                    ? ""
                    : "Category Name should contain only alphabets and first letter should be capital";
                break;
            default:
